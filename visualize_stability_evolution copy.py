...
def process_stability_stats(all_dfs):
    ...
    exclude_iterations = [100, 200, 300, 400, 600, 700, 800, 900]
    ...
    grouped = combined_df.groupby('iteration')['stability'].agg(['mean', 'std'])
...
if __name__ == "__main__":
    ...
    print("Plotting...")
    plot_stability_evolution(data_store, save_path=f"0617\{alg}_stability_noise_mnist.png")
